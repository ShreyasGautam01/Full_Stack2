...
Path|Component Rendered|Description| /Profile|<Profile />|Displays name and job title. /Dashboard|<Dashboard />|Displays developer skills (HTML, CSS).

## How to Run
Start the development server: npm start.

Open your browser to http://localhost:3000/Profile to see the profile view.
